...
class ProxmoxResourceUnavailableError(ProxmoxMCPError):
    ...
    def __init__(self, message: str, resource_type: Optional[str] = None,
                 resource_id: Optional[str] = None, reason: Optional[str] = None, **kwargs):
...
class ProxmoxConfigError(ProxmoxMCPError):
    ...
    def __init__(self, message: str, config_file: Optional[str] = None,
                 config_field: Optional[str] = None, **kwargs):
...
class ProxmoxValidationError(ProxmoxMCPError):
    ...
    def __init__(self, message: str, field: Optional[str] = None,
                 value: Optional[Any] = None, expected_type: Optional[str] = None, **kwargs):
...
def map_proxmox_error(error: Exception, operation: str = "", 
                     resource_type: str = "", resource_id: str = "") -> ProxmoxMCPError:
    ...
    if any(keyword in error_str for keyword in ['offline', 'stopped', 'unavailable', 'not running']):
